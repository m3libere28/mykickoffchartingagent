...
const Dashboard = ({ onUploadSuccess }) => {
  ...
  return (
    <div className="w-full mx-auto p-4 sm:p-6 lg:p-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      /* Paste Text Zone */
      <div className={`relative rounded-2xl overflow-hidden bg-white dark:bg-darkSurface-card border shadow-sm transition-all duration-300 border-slate-200 dark:border-darkSurface-border`}>
        <div className="px-5 py-3 border-b border-slate-100 dark:border-darkSurface-border/50 bg-slate-50/50 dark:bg-darkSurface/50 flex flex-wrap items-center">
          <div className="flex items-center mr-auto">
            ...
            <span className="text-sm font-semibold text-slate-600 dark:text-darkSurface-muted">Paste clinical notes</span>
          </div>
