        ...
        <div className="relative">
          ...
          <div className="flex items-center mb-3">
            <div className="bg-white dark:bg-darkSurface-card rounded-lg p-0.5 shadow-sm border border-slate-200/60 dark:border-darkSurface-border/60 flex">
              ...
              >
                <ClipboardPaste size={13} className="mr-1" /> Paste Text
              </button>
            </div>
          </div>
          ...
          <div className={`relative rounded-xl overflow-hidden bg-white dark:bg-darkSurface-card border shadow-sm transition-all duration-300 border-slate-200 dark:border-darkSurface-border`}>
            <div className="px-4 py-2.5 border-b border-slate-100 dark:border-darkSurface-border/50 bg-slate-50/50 dark:bg-darkSurface/50 flex flex-wrap items-center">
              <div className="flex items-center mr-auto">
                ...
                <span className="text-xs font-semibold text-slate-500 dark:text-darkSurface-muted">Paste previous notes</span>
              </div>
          ...
          <div className={`relative rounded-xl overflow-hidden bg-white dark:bg-darkSurface-card border shadow-sm transition-all duration-300 border-slate-200 dark:border-darkSurface-border`}>
            <div className="px-4 py-2.5 border-b border-slate-100 dark:border-darkSurface-border/50 bg-slate-50/50 dark:bg-darkSurface/50 flex flex-wrap items-center">
              <div className="flex items-center mr-auto">
                ...
                <span className="text-xs font-semibold text-slate-500 dark:text-darkSurface-muted">Paste new notes</span>
              </div>
